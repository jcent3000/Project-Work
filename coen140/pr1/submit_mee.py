...
df_te = pd.read_csv(
    filepath_or_buffer='test.dat', delimiter='\t',header=None)
df_tr = pd.read_csv(
    filepath_or_buffer='train.dat', delimiter='\t',header=None)
df_format = pd.read_csv(
    filepath_or_buffer='format.dat',header=None)
...
# For testing training accuaracy
